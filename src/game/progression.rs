...
impl StatIncreases {
    pub fn new() -> Self {
        Self {
            max_hp: 10, max_mp: 5, attack: 2, defense: 1,
            magic_attack: 2, magic_defense: 1, agility: 1,
        }
    }

    pub fn total_stats_gained(&self) -> u32 {
        self.max_hp + self.max_mp + self.attack + self.defense 
            + self.magic_attack + self.magic_defense + self.agility
    }
}
...
impl SkillTree {
    ...
    fn create_skill_tree(class: Class) -> Vec<SkillTreeNode> {
        match class {
            Class::TwinBlade => vec![
                SkillTreeNode {
                    id: "twin_slash".to_string(), name: "Twin Slash".to_string(),
                    description: "A quick double slash attack".to_string(),
                    skill: Skill::new("twin_slash", "Twin Slash", Element::Null, 20, 5, 1.0),
                    required_level: 1, required_nodes: vec![],
                    unlocked: true, position_x: 100.0, position_y: 200.0,
                },
                SkillTreeNode {
                    id: "wind_slash".to_string(), name: "Wind Slash".to_string(),
                    description: "A wind-element slash attack".to_string(),
                    skill: Skill::new("wind_slash", "Wind Slash", Element::Wind, 35, 10, 3.0),
                    required_level: 3, required_nodes: vec!["twin_slash".to_string()],
                    unlocked: false, position_x: 250.0, position_y: 150.0,
                },
                SkillTreeNode {
                    id: "swift_blade".to_string(), name: "Swift Blade".to_string(),
                    description: "A lightning-fast blade strike".to_string(),
                    skill: Skill::new("swift_blade", "Swift Blade", Element::Null, 15, 3, 0.5),
                    required_level: 5, required_nodes: vec!["wind_slash".to_string()],
                    unlocked: false, position_x: 400.0, position_y: 200.0,
                },
                SkillTreeNode {
                    id: "cyclone".to_string(), name: "Cyclone".to_string(),
                    description: "A spinning wind attack that hits all enemies".to_string(),
                    skill: Skill::new("cyclone", "Cyclone", Element::Wind, 50, 20, 6.0),
                    required_level: 10, required_nodes: vec!["swift_blade".to_string()],
                    unlocked: false, position_x: 550.0, position_y: 250.0,
                },
            ],
            Class::HeavyBlade => vec![
                SkillTreeNode {
                    id: "heavy_strike".to_string(), name: "Heavy Strike".to_string(),
                ...
                SkillTreeNode {
                    id: "earth_crush".to_string(), name: "Earth Crush".to_string(),
                    ...
                    required_level: 3, required_nodes: vec!["heavy_strike".to_string()],
                    unlocked: false, position_x: 250.0, position_y: 150.0,
                },
                SkillTreeNode {
                    id: "defense_up".to_string(), name: "Defense Up".to_string(),
                    description: "Temporarily increases defense".to_string(),
                    skill: Skill::new("defense_up", "Defense Up", Element::Null, 0, 8, 5.0),
                    required_level: 5, required_nodes: vec!["earth_crush".to_string()],
                    unlocked: false, position_x: 400.0, position_y: 200.0,
                },
                SkillTreeNode {
                    id: "titan_cleave".to_string(), name: "Titan Cleave".to_string(),
                    ...
                    required_level: 10, required_nodes: vec!["defense_up".to_string()],
                    unlocked: false, position_x: 550.0, position_y: 250.0,
                },
            ],
            Class::LongArm => vec![
                SkillTreeNode {
                    id: "spiral_stab".to_string(), name: "Spiral Stab".to_string(),
                ...
                SkillTreeNode {
                    id: "flame_lance".to_string(), name: "Flame Lance".to_string(),
                    description: "A fire-element lance thrust".to_string(),
                    skill: Skill::new("flame_lance", "Flame Lance", Element::Fire, 45, 12, 3.5),
                    required_level: 3, required_nodes: vec!["spiral_stab".to_string()],
                    unlocked: false, position_x: 250.0, position_y: 150.0,
                },
                SkillTreeNode {
                    id: "ice_spear".to_string(), name: "Ice Spear".to_string(),
                    description: "A water-element spear attack".to_string(),
                    skill: Skill::new("ice_spear", "Ice Spear", Element::Water, 40, 12, 3.5),
                    required_level: 5, required_nodes: vec!["flame_lance".to_string()],
                    unlocked: false, position_x: 400.0, position_y: 200.0,
                },
                SkillTreeNode {
                    id: "dragon_thrust".to_string(), name: "Dragon Thrust".to_string(),
                    ...
                    required_level: 10, required_nodes: vec!["ice_spear".to_string()],
                    unlocked: false, position_x: 550.0, position_y: 250.0,
                },
            ],
            Class::Wavemaster => vec![
                SkillTreeNode {
                    id: "fireball".to_string(), name: "Fireball".to_string(),
                ...
                SkillTreeNode {
                    id: "heal".to_string(), name: "Heal".to_string(),
                    description: "Restores HP to an ally".to_string(),
                    skill: Skill::new("heal", "Heal", Element::Light, 0, 20, 4.0),
                    required_level: 3, required_nodes: vec!["fireball".to_string()],
                    unlocked: false, position_x: 250.0, position_y: 150.0,
                },
                SkillTreeNode {
                    id: "thunder_bolt".to_string(), name: "Thunder Bolt".to_string(),
                    ...
                    required_level: 5, required_nodes: vec!["heal".to_string()],
                    unlocked: false, position_x: 400.0, position_y: 200.0,
                },
                SkillTreeNode {
                    id: "meteor".to_string(), name: "Meteor".to_string(),
                    description: "An ultimate fire-element spell".to_string(),
                    skill: Skill::new("meteor", "Meteor", Element::Fire, 100, 35, 10.0),
                    required_level: 10, required_nodes: vec!["thunder_bolt".to_string()],
                    unlocked: false, position_x: 550.0, position_y: 250.0,
                },
            ],
        }
    ...
    pub fn unlock_skill(&mut self, node_id: &str) -> Result<(), &str> {
        ...
        if let Some(idx) = node_idx {
            ...
            for req_id in &required_nodes {
                if !self.nodes.iter().any(|n| n.id == req_id.as_str() && n.unlocked) {
    ...
    pub fn get_available_skills(&self) -> Vec<&SkillTreeNode> {
        self.nodes.iter()
            ...
            .filter(|n| {
                ...
                n.required_nodes.iter().all(|req_id| {
                    self.nodes.iter().any(|n2| n2.id == *req_id && n2.unlocked)
                })
            })
            .collect()
    }
    ...
    pub fn can_unlock(&self, node_id: &str) -> bool {
        ...
        if let Some(node) = self.nodes.iter().find(|n| n.id == node_id) {
            ...
            node.required_nodes.iter().all(|req_id| {
                self.nodes.iter().any(|n| n.id == *req_id && n.unlocked)
            })
        } else {
            false
        }
...
impl ProgressionSystem {
    pub fn apply_level_up(stats: &mut Stats, skill_tree: &mut SkillTree, event_bus: &mut EventBus) -> LevelUpScreen {
        // Add skill point
        ...
        event_bus.emit(GameEvent::LevelUp { new_level: stats.level });
        
        screen
    }

    pub fn check_level_up(stats: &Stats, exp_gained: u64, skill_tree: &mut SkillTree, event_bus: &mut EventBus) -> Option<LevelUpScreen> {
